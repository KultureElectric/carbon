...
- **Rust**: 1.95.0 (pinned via [`rust-toolchain.toml`](rust-toolchain.toml)). Published crates target **MSRV 1.95.0** (set in the workspace manifest and [`clippy.toml`](clippy.toml)).
